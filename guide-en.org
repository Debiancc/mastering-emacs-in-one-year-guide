...
Updated: <2016-09-03 Sat>

Created: <2012-01-31 Tue>
...
** Attitude matters
*** Understand Software Freedom
Once you truly understand [[https://www.gnu.org/philosophy/free-sw.html][Software Freedom]], Emacs becomes really simple.

For example, the essence of Emacs package is a plain text file named =archive-contents=. Emacs will fetch remote or local =archive-contents= at first.

 [[http://emacs.stackexchange.com/questions/tagged/package][many packages management questions]] are asked every year.
